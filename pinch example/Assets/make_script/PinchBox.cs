...
namespace Leap.Unity.DetectionExamples
{
    ...
    public class PinchBox : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            {
                Debug.LogWarning("No pinch detectors were specified!  PinchBox can not draw any lines without PinchDetectors.");
            }
        }
        ...
        private class DrawState
        {
            ...
            public DrawState(PinchBox parent)
            {
                _parent = parent;
